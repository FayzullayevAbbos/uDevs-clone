...
const Clients = () => {
  return (
    <div id='clients' className='bg-[#f4f7ff] py-5 lg:py-20'>
      <div className=''>
        <div className='mx-auto max-w-6xl'>
          <h1 className='mb-10 px-4 text-[32px] lg:text-[64px] font-extrabold leading-[64px] text-[#1b5bf7]'>
            Our clients
          </h1>
        </div>
        <div>
          <div>
            <marquee behavior='scroll' direction='left'>
              <div className='flex  gap-5 py-5'>
                <img
                  className='h-32 w-[150px] lg:w-[213px] transition duration-300 hover:scale-[1.07]'
                  src={AkfaMedline}
                  alt='AkfaMedline'
                />
                <img
